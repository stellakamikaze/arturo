...
```
**[TARGET] Target:** Midjourney · ** Framework:** Visual Descriptor · ** Tokens:** Light (~60) · **[NOTA] Strategy:** Comma-separated descriptors over prose, lighting and mood anchored early, aspect ratio and version locked, negative prompt prevents style drift.
...
```
**[TARGET] Target:** Claude Code · ** Tokens:** Medium (~380) · **[NOTA] Strategy:** Every vague Notion aesthetic cue translated into exact hex values and pixel specs — Claude Code cannot guess wrong. Animations defined with exact timing, method, and trigger so there is no interpretation needed.
...
| **Open-weight instruct / reasoning** | Open-weight LLM | Chat template format, thinking vs non-thinking mode detection |
...
## [NO] 37 Credit-Killing Patterns Detected (with Before/After Examples)
...
| 33 | **Silent agent** | No progress output | "After each step output: [OK] [what was completed]" |
